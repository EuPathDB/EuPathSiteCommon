...
mywget https://cbilsvn.pmacs.upenn.edu/svn/apidb/EuPathSiteCommon/trunk/Model/lib/yaml/metaConfig.yaml.sample
...
mywget https://cbilsvn.pmacs.upenn.edu/svn/apidb/EuPathSiteCommon/trunk/Model/bin/eupathSiteConfigure
