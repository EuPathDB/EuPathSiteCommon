...
<div style="">
  ...
  <ul class="cirbulletlist">
    <li>
      If you see a <span style="color:red">red X</span> or <span style="font-weight:bold">a step showing 0</span>
      results, please click on the Edit button, that appears as you mousoever each step, and choose 'Revise'.
      Re-run the step after adjusting parameters as needed.
    </li>
    <li>
